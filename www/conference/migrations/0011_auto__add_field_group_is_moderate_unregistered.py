...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.is_moderate_unregistered'
        db.add_column('conference_group', 'is_moderate_unregistered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.is_moderate_unregistered'
        db.delete_column('conference_group', 'is_moderate_unregistered')
