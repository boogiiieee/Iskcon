...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.is_behalf_author'
        db.add_column('conference_group', 'is_behalf_author',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Message.text'
        db.alter_column('conference_message', 'text', self.gf('redactor.fields.RedactorField')(max_length=10000))

    def backwards(self, orm):
        # Deleting field 'Group.is_behalf_author'
        db.delete_column('conference_group', 'is_behalf_author')


        # Changing field 'Message.text'
        db.alter_column('conference_message', 'text', self.gf('django.db.models.fields.TextField')(max_length=10000))
    ...
    models = {
        ...
        'conference.group': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'is_add_postfix_email': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
