...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.server_email_login'
        db.alter_column('conference_group', 'server_email_login', self.gf('django.db.models.fields.EmailField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Group.server_email_login'
        db.alter_column('conference_group', 'server_email_login', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'conference.group': {
            ...
            'server_email_login': ('django.db.models.fields.EmailField', [], {'max_length': '100', 'blank': 'True'}),
            'server_email_passw': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
