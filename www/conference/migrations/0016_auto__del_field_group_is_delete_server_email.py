...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Group.is_delete_server_email'
        db.delete_column('conference_group', 'is_delete_server_email')


    def backwards(self, orm):
        # Adding field 'Group.is_delete_server_email'
        db.add_column('conference_group', 'is_delete_server_email',
