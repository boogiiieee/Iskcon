...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'GroupUserRel', fields ['date_ban_end']
        db.create_index('conference_groupuserrel', ['date_ban_end'])

        # Adding index on 'GroupUserRel', fields ['is_frozen']
        db.create_index('conference_groupuserrel', ['is_frozen'])

        # Adding index on 'MessageRecipientRel', fields ['is_read']
        db.create_index('conference_messagerecipientrel', ['is_read'])

        # Adding index on 'MessageRecipientRel', fields ['is_removed']
        db.create_index('conference_messagerecipientrel', ['is_removed'])

        # Adding index on 'MessageRecipientRel', fields ['is_sent_email']
        db.create_index('conference_messagerecipientrel', ['is_sent_email'])


    def backwards(self, orm):
        # Removing index on 'MessageRecipientRel', fields ['is_sent_email']
        db.delete_index('conference_messagerecipientrel', ['is_sent_email'])

        # Removing index on 'MessageRecipientRel', fields ['is_removed']
        db.delete_index('conference_messagerecipientrel', ['is_removed'])

        # Removing index on 'MessageRecipientRel', fields ['is_read']
        db.delete_index('conference_messagerecipientrel', ['is_read'])

        # Removing index on 'GroupUserRel', fields ['is_frozen']
        db.delete_index('conference_groupuserrel', ['is_frozen'])

        # Removing index on 'GroupUserRel', fields ['date_ban_end']
        db.delete_index('conference_groupuserrel', ['date_ban_end'])
    ...
    models = {
        ...
        'conference.groupuserrel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_ban_end': ('django.db.models.fields.DateField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['conference.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'is_frozen': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'sort': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
        ...
        'conference.message': {
            ...
            'recipients': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'through': "orm['conference.MessageRecipientRel']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True', 'db_index': 'True'}),
        ...
        'conference.messagerecipientrel': {
            ...
            'is_removed': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'is_sent_email': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
