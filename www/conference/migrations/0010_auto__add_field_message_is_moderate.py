...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.is_moderate'
        db.add_column('conference_message', 'is_moderate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.is_moderate'
        db.delete_column('conference_message', 'is_moderate')
