...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.server_email_protocol'
        db.add_column('conference_group', 'server_email_protocol',
                      self.gf('django.db.models.fields.CharField')(default=u'pop3+ssl', max_length=100),
                      keep_default=False)

        # Adding field 'Group.server_email_domain'
        db.add_column('conference_group', 'server_email_domain',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Group.server_email_port'
        db.add_column('conference_group', 'server_email_port',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=995),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.server_email_protocol'
        db.delete_column('conference_group', 'server_email_protocol')

        # Deleting field 'Group.server_email_domain'
        db.delete_column('conference_group', 'server_email_domain')

        # Deleting field 'Group.server_email_port'
        db.delete_column('conference_group', 'server_email_port')
    ...
    models = {
        ...
        'conference.group': {
            ...
            'server_email_domain': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'server_email_login': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'server_email_passw': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'server_email_port': ('django.db.models.fields.PositiveIntegerField', [], {'default': '995'}),
            'server_email_protocol': ('django.db.models.fields.CharField', [], {'default': "u'pop3+ssl'", 'max_length': '100'}),
            'sort': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
        ...
        'conference.messagefile': {
            'Meta': {'ordering': "['id']", 'object_name': 'MessageFile'},
