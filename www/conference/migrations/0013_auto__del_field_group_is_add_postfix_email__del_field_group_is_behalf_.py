...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Group.is_add_postfix_email'
        db.delete_column('conference_group', 'is_add_postfix_email')
    ...
    def backwards(self, orm):
        # Adding field 'Group.is_add_postfix_email'
        db.add_column('conference_group', 'is_add_postfix_email',
