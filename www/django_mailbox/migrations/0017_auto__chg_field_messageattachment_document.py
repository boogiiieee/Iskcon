...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MessageAttachment.document'
        db.alter_column('django_mailbox_messageattachment', 'document', self.gf('django.db.models.fields.files.FileField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'MessageAttachment.document'
        db.alter_column('django_mailbox_messageattachment', 'document', self.gf('django.db.models.fields.files.FileField')(max_length=100))
