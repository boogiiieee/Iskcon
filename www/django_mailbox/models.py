...
class Mailbox(models.Model):
    ...
    uri = models.CharField(
        ...
        max_length=255,
        help_text=(_(
            "Example: scheme,username,password,hostname,port<br />"
            "<br />"
...
class MessageAttachment(models.Model):
    def make_upload_path(instance, filename):
        ...
        return u'upload/mailbox_attachments/%d/%s' % (
            instance.message.mailbox_id, filename
        )
    ...
    def get_filename(self):
        return get_filename_from_message(self._get_rehydrated_headers())
